...
import img1 from "../../../assets/s3Bucket.png";
...
function SideBord() {
  ...
  return (
    <div
      className="w-1/2 flex justify-center items-center relative mask-x-from-88% mask-x-to-100% mask-y-from-88% mask-y-to-100%"
      ref={scope}
    >
